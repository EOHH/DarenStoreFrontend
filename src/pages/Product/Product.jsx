...
const Product = () => {
  ...
  const isOnSale = product.discount > 0 || false;
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 4,
      date: 'Hace 2 semanas',
      comment: 'Muy bonitas y cómodas, aunque tardaron un poco más de lo esperado en llegar.'
    }
  ];

  const specifications = [
    { label: 'Marca', value: product.brand || 'Premium Brand' },
    { label: 'Material exterior', value: 'Cuero sintético premium' },
    { label: 'Material interior', value: 'Textil transpirable' },
    ...
    <div className="product-page">
        ...
        <div className="product-detail__image-gallery">
          <div className="product-detail__main-image">
            ...
            <div className="product-detail__badges">
              {isNew && (
                <span className="product-detail__badge product-detail__badge--new">Nuevo</span>
              )}
              {isOnSale && (
          ...
          {sizes.length > 0 && (
            <div className="product-detail__size-section">
              <div className="product-detail__size-header">
                <span className="product-detail__size-label">
                  Selecciona tu talla
                </span>
      ...
      <div className="product-detail__tabs">
        <div className="product-detail__tab-buttons">
          <button
            className={`product-detail__tab-btn ${activeTab === 'description' ? 'product-detail__tab-btn--active' : ''}`}
            onClick={() => setActiveTab('description')}
          >
            Descripción
          </button>
          <button
            className={`product-detail__tab-btn ${activeTab === 'specifications' ? 'product-detail__tab-btn--active' : ''}`}
        ...
        <div className={`product-detail__tab-content ${activeTab === 'description' ? 'product-detail__tab-content--active' : ''}`}>
          ...
          <p>
            ...
            Fabricadas con materiales de alta calidad que garantizan durabilidad y confort en cada paso.
          </p>
          ...
          <div className="product-detail__reviews">
            <div className="product-detail__review-summary">
              <div className="product-detail__review-average">
                ...
                <span className="product-detail__review-total">
                ...
                <div key={review.id} className="product-detail__review-item">
                  <div className="product-detail__review-header">
                    <div className="product-detail__review-author">
                      <div className="product-detail__review-avatar">
        ...
        <div className="product-detail__related">
          <div className="product-detail__related-header">
            ...
            <p className="product-detail__related-subtitle">
              Productos similares que otros clientes han comprado
            </p>
          </div>
